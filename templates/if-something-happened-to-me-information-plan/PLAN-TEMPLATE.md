...
Use this as a handoff map, not a warehouse. Write enough that someone you trust can orient themselves without having to reconstruct your household from scattered records, inboxes, and memory.
...
Examples: an insurance claim waiting on an estimate; a repair that did not solve the problem; a refund still pending; a school or care issue awaiting a response; a vehicle warning light being monitored.
...
Examples: important bills, renewals, prescriptions, appointments, maintenance, registrations, care routines, or other obligations that continue without you.

## 5. Protected digital access
...
Do not copy passwords, recovery codes, security answers, encryption keys, banking credentials, or other secrets here.
...
Give someone appropriate the starting point and imagine you cannot answer follow-up questions.
...
## 8. Review when the handoff changes
