...
**Version 1.0.0.** A plain-language preflight for spotting CSV values that may be changed, misread, or rejected when you import them into a spreadsheet, CRM, accounting tool, or another app.
...
- duplicate values in a column you choose to treat as an identifier.
...
The planned browser checker reads the CSV locally in your browser. It does not need an Eterna account or a backend upload.
